...
export default {
  ...
  header: [
    ...
    },
    {
      label: "Stack",
      value:
        "Figma, Suite Affinity, Suite Adobe, Typescript"
    }
  ],
    ...
    value: [
      ...
      },
      {
        ...
        role: [
          ...
          "Design Thinking",
          "Test utilisateurs et feedback (A/B testing)",
...

      {
        ...
        company: "SOFICA",
        city: "Nice",
        title: "UI/UX Designer & Développeur Frontend",
        tech: ["Vue.js", "Nuxt.js", "TailwindCSS", "TypeScript", "Node.js"],
        description: [
          ...
          "Je suis intervenu à la SOFICA dans le cadre de la création d'une plateforme de gestion de comptabilité à destination des particuliers sous forme de SAAS."
        ],

        role: [
          "Prototypage et wireframing",
          "Design Thinking",
          "Product Design : Conception de l'UX/UI de la plateforme",
          "Implémentaion d'un Design System",
...

      {
        ...
        role: [
          ...
          "Développement créatif (animation design, micro-interactions, animations SVG)",
...

      {
        ...
        company: "Be Creative",
        city: "Marseille",
        title: "Co-fondateur, Web Designer",
        tech: ["Vue.js", "Nuxt.js", "TailwindCSS", "TypeScript", "Node.js"],
        description: [
        ...
        role: [
          "Rôle de CTO",
          "UI Design et développement de sites web et applications (SSR et CSR) basées sur des CMS Headless  (Strapi, Storyblok)",
